...
import { crearReporte, actualizarReporte, obtenerFaenas } from '@/lib/api';
...
export default function FormularioReporteTrabajador({ reporte, onGuardado }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      estado: 'Abierto',
      auditoria_id: null, // Se fuerza a null
    };
    ...
    if (res?.id) {
      ...
      setMensaje(res?.mensaje || '❌ Error al guardar el reporte');
    }
  };
